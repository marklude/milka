...
# Install dependencies
COPY --chown=ftuser:ftuser requirements.txt requirements-hyperopt.txt requirements-plot.txt requirements-freqai.txt requirements-freqai-rl.txt /freqtrade/
USER ftuser
